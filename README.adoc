...
* *CONTROL + OPTION + COMMAND + 2:* CleanShot (capture area and annotate)
* *CONTROL + OPTION + COMMAND + 3:* CleanShot (capture window)
* *CONTROL + OPTION + COMMAND + 4:* CleanShot (capture fullscreen)
* *CONTROL + OPTION + COMMAND + 5:* CleanShot (capture with timer)
* *CONTROL + OPTION + COMMAND + 6:* CleanShot (capture with scroll)
* *CONTROL + OPTION + COMMAND + 7:* CleanShot (record screen start/stop)
