...
* link:https://diffusionbee.com[DiffusionBee]
...
** General
*** Login Items
**** Ensure only _Alfred_ and _Carbon Copy Cloner_ are listed.
*** Language and Region
...
*** Enable _FileVault_.
** Displays
*** Click _Advanced_ and enable _Prevent automatic sleeping on power adapter when the
display is off_.
** Wallpaper
...
** Touch ID & Password
*** Rename fingerprint.
*** Enable use of Touche ID for all settings.
