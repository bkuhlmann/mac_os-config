...
* link:https://codeberg.org/roble/noti[Noti]
...
* link:https://github.com/pwa-today/pwa-check[PWA Check]
...
**** Use custom and select _Message_.
** Spotlight
...
** Lock Screen
*** Set _Show message when locked_ with custom text.
** Battery
...
*** Keyboard Shortcuts
**** Select _Dock_ and uncheck _Turn Dock Hiding On/Off_.
**** Select _Mission Control_ and assign `CONTROL + OPTION + COMMAND + W` to _Mission Control_.
