...
* 🟢 Added Atuin Rust crate - Brooke Kuhlmann
* 🟢 Added Protobuf Homebrew formula - Brooke Kuhlmann
* 🟢 Added version release notes - Brooke Kuhlmann
* 🔼 Updated to Acorn 8.0.0 - Brooke Kuhlmann
* 🔼 Updated to Caliber 0.68.0 - Brooke Kuhlmann
* 🔼 Updated to Git Lint 9.0.0 - Brooke Kuhlmann
* 🔼 Updated to Ruby 3.4.0 - Brooke Kuhlmann
* ⛔️ Removed HTTPie Homebrew formula - Brooke Kuhlmann
* ⛔️ Removed Muzzle Homebrew cask - Brooke Kuhlmann
* ⛔️ Removed Nushell - Brooke Kuhlmann
* ⛔️ Removed Repl Type Completer gem - Brooke Kuhlmann
* ⛔️ Removed Shush App Store application - Brooke Kuhlmann
* ⛔️ Removed Tealdeer Homebrew formula - Brooke Kuhlmann
* ⛔️ Removed XSV Homebrew formula - Brooke Kuhlmann
* ⛔️ Removed ioping Homebrew formula - Brooke Kuhlmann

== 28.3.0 (2024-11-11)

* ✅ Fixed HTTP Fake CCMenu label - Brooke Kuhlmann
* 🟢 Added Brave BOM - Brooke Kuhlmann
* 🟢 Added GPG Pinentry Homebrew formula - Brooke Kuhlmann
* 🟢 Added version release notes - Brooke Kuhlmann
...
* ✅ Fixed wholeable typo for defaults - Brooke Kuhlmann
* 🟢 Added Brave browser Homebrew cask - Brooke Kuhlmann
* 🟢 Added Infuse App Store application - Brooke Kuhlmann
* 🔼 Updated to Ruby 3.3.6 - Brooke Kuhlmann

== 28.0.0 (2024-09-19)

* 🟢 Added AppMap application - Brooke Kuhlmann
* 🟢 Added Dropover Apple Store application - Brooke Kuhlmann
* 🟢 Added Retest Ruby gem - Brooke Kuhlmann
* 🟢 Added version release notes - Brooke Kuhlmann
* 🔼 Updated to CCMenu 25.0.0 defaults - Brooke Kuhlmann
* 🔼 Updated to Moom 4.0.0 - Brooke Kuhlmann
* ⛔️ Removed Bitwarden CLI - Brooke Kuhlmann
* ⛔️ Removed DisplayLink application - Brooke Kuhlmann
* ⛔️ Removed GPG Pinentry Homebrew formula - Brooke Kuhlmann
* ⛔️ Removed NCurses Disk Usage Homebrew formula - Brooke Kuhlmann
* ⛔️ Removed Yank Homebrew formula - Brooke Kuhlmann
* ⛔️ Removed hr Homebrew formula - Brooke Kuhlmann
* 🔁 Refactored Dust as Homebrew Formula - Brooke Kuhlmann

== 27.1.1 (2024-09-03)

* ✅ Fixed App Store links - Brooke Kuhlmann
* 🟢 Added README Developer Certificate of Origin documentation - Brooke Kuhlmann
* 🔼 Updated to Ruby 3.3.5 - Brooke Kuhlmann

== 27.1.0 (2024-07-20)

* 🟢 Added Dust Rust create - Brooke Kuhlmann
* 🟢 Added Eza Rust crate - Brooke Kuhlmann
* 🟢 Added Tuple application - Brooke Kuhlmann
* 🟢 Added Vale Homebrew formula - Brooke Kuhlmann
* 🔼 Updated to Ruby 3.3.4 - Brooke Kuhlmann
* ⛔️ Removed Exa - Brooke Kuhlmann

== 27.0.0 (2024-07-08)

* 🟢 Added Ice application - Brooke Kuhlmann
* 🔼 Updated to Caliber 0.58.0 - Brooke Kuhlmann
* 🔼 Updated to Git Lint 8.0.0 - Brooke Kuhlmann
* 🔼 Updated to Ruby 3.3.3 - Brooke Kuhlmann
* ⛔️ Removed Bartender Homebrew cask - Brooke Kuhlmann
